...
export const FeedbackSection: React.FC = () => {
  const FEEDBACKS = [
    {
      ...
      content: "“Ban đầu mình chỉ thử chuyển dổi vào việc quản lý tổ chức. Mình cũng không nghĩ rằng Symody lại giúp đỡ tổ chức mình đơn giản hóa các quy trình đến như vậy. “ ",
      name: "Anh Hoàng Minh",
    ...
    },
    {
      ...
      content: "“Symlody đã thật sự giải quyết được nổi đau mà bấy lâu nay tổ chức của mình đang đối mặt. Các thành viên trong CLB đã có thể định hướng rõ ràng các mục tiêu khi tham gia tổ chức “ ",
      name: "Chị Diễm Quỳnh",
  ...
  return (
    <SectionContainer title="Khách hàng nói gì về Symlody?" className="flex flex-1 bg-[url('/images/home/bg_feedback.png')] bg-no-repeat bg-[length:100%_100%]">
      <h3 className="mt-4 text-base text-gray-400 text-center">Giải quyết nỗi đau mà người lãnh đạo đang gặp</h3>
